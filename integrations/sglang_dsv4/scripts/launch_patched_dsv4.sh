...
export CSAHCA_DSV4_REPLACE_REQUIRE_FINITE_Q="${CSAHCA_DSV4_REPLACE_REQUIRE_FINITE_Q:-1}"
export CSAHCA_DSV4_REPLACE_MAX_ABS_Q="${CSAHCA_DSV4_REPLACE_MAX_ABS_Q:-1000000}"
export CSAHCA_DSV4_Q_SUSPICIOUS_ABS="${CSAHCA_DSV4_Q_SUSPICIOUS_ABS:-1000000}"
