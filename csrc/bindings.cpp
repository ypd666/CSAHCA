...
torch::Tensor dsv4_decode_forward_tiled(
    torch::Tensor q,
    torch::Tensor paged_k_cache_u8,
    torch::Tensor token_indices,
    torch::Tensor topk_lengths,
  ...
  return dsv4_decode_forward_tiled_cuda(
      q,
      paged_k_cache_u8,
      token_indices,
      topk_lengths,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("dsv4_decode_forward_tiled", &dsv4_decode_forward_tiled, "Tiled DSV4 SWA + optional C4/C128 paged FP8 decode forward (CUDA)");
}
